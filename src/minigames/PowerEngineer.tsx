...
export const PowerEngineerMinigame: React.FC<MinigameProps> = ({ reactorEnergy, shipHealth, onComplete }) => {
  ...
  const inputDirRef = React.useRef<InputDir>(0);
  const [inputDir, setInputDir] = React.useState<InputDir>(0);
